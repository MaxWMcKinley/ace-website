$.getJSON("../php/get-events.php", function(result){
	...
	$.each( result, function( key, value ) {
  		events += `
			<button type='button' class='list-group-item' data-toggle='modal' data-target='#eventModal' data-name='${key}' data-officername='${value.officer_name}' data-date='${value.date}' data-freeze='${value.freeze}' data-type='${value.type}' data-points='${value.points}'>
